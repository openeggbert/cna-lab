...
All of gates M0-M8 are now done. Next: **M9 — Mafia-1-fidelity traffic, pedestrians, and one police-response scenario** surviving ten minutes of walking/driving interaction in the first district (`plan/plan_39-vertical-slice-gates.md` gate M9, task `IS-39-010`).
