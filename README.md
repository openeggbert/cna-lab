...
Next: **M7 — one data-driven mission**, controlling dialogue, objective UI, vehicle entry, destination trigger, checkpoint, and completion (`plan/plan_39-vertical-slice-gates.md` gate M7, task `IS-39-008`).
