...
- `P`: pause / resume
- `Tab`: open / close the explored-area map; it includes a marker legend and `POWER`/`TERMINAL` progress, while red `GOAL` marks a locked exit and cyan `GOAL` an active exit
- `Escape`: quit
