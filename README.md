...
Next: **M8 — one in-engine cutscene** that can play, skip, save-safe finalize, and hand control back correctly (`plan/plan_39-vertical-slice-gates.md` gate M8, task `IS-39-009`).
