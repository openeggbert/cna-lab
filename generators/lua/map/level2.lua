...
--
-- M308 (MAP18, 2026-07-10) — Lua child-tile generator for level 2 ("—" in
-- map.md's own level table, ~5,646 km, between Planet=0 and Continent=3).
-- Registered as "lua.map.child.level2.default" so MapPipeline's level-
-- aware Lua lookup only tries this for level-2 tiles.
--
...
local M = {}
M.id       = "lua.map.child.level2.default"
M.version  = "0.1.0"
M.category = "map"
