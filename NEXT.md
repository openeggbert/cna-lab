...
2. Add sprite/image/animation visuals alongside the existing procedural
   primitives without removing the asset-free path.
...
5. Add richer scripted sequences: waits, camera/presentation cues, conditional
