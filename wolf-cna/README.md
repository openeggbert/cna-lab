...
- each sector is clad in one of four original generated material families — cool bunker stone, dark industrial brick, teal riveted steel or cold laboratory panels — chosen from a hash of the level itself, so sectors look unlike each other and no room mixes families
