...
--
-- M305 (MAP18, 2026-07-10) — Lua child-tile generator for level 8 ("—" in
-- map.md's own level table, ~88 km, between Region=7 and Metro=9).
-- Registered as "lua.map.child.level8.default" so MapPipeline's level-
-- aware Lua lookup only tries this for level-8 tiles.
--
...
local M = {}
M.id       = "lua.map.child.level8.default"
M.version  = "0.1.0"
M.category = "map"
