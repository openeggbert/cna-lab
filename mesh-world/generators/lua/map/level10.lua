...
--
-- M303 (MAP18, 2026-07-10) — Lua child-tile generator for level 10 ("—" in
-- map.md's own level table, ~22 km, between Metro=9 and City=12).
-- Registered as "lua.map.child.level10.default" so MapPipeline's level-
-- aware Lua lookup only tries this for level-10 tiles.
--
...
-- defined purpose for this level.
--
...
local M = {}
M.id       = "lua.map.child.level10.default"
M.version  = "0.1.0"
M.category = "map"
