...
|---|---|---|---|
| CNA (`../cnanext`) | Public game/framework abstraction | `next`, web executable verified at `14ff4be7c9690ead2030a02878c6be39802f6863` | Microsoft Public License; 5 external uncommitted ContentManager/SDL3 paths during final web verification |
