...
- [ ] **IG-35-034 P1** — Define scope and implement the smallest working physics profiler (body/contact/query counts, step time).
- [ ] **IG-35-035 P1** — Add unit tests and one real-flow integration test for the physics profiler.
- [ ] **IG-35-036 P2** — Add logging/overlay output and documentation for the physics profiler.
