...
- [ ] **IG-17-001 P0** — Preserve the current kinematic controller as a deterministic fallback/test vehicle.
- [ ] **IG-17-002 P0** — Create a raycast-vehicle prototype in the selected physics library.
- [ ] **IG-17-003 P0** — Define a versioned vehicle configuration schema.
- [ ] **IG-17-004 P0** — Implement chassis mass, center of mass, wheels, suspension, engine, gears, brakes, and steering.
