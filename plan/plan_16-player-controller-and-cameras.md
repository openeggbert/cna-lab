...
- [ ] **IG-16-003 P0** — Create camera collision and obstruction handling.
- [ ] **IG-16-004 P0** — Create interaction prompts for the car and mission objects.
- [ ] **IG-16-005 P1** — Add acceleration, deceleration, turning inertia, and slope handling.
