...
| Child | Marutchi | Two home silhouettes transcribed; clean-state path provisional |
...
redraws, remaining care-action frames, and every branch condition remain open until
