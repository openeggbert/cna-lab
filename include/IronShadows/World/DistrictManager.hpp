...
namespace IronShadows
{
    ...
    // IS-13-001/002/006/010/013). No background loading, no streaming: a transition destroys the
    ...
    // display time (IS-13-013), not to hide real asynchronous work (there is none yet; that is
    // separate, larger follow-up work, see IS-13-034/035).
    ...
    public:
        ...
        // when this returns true (IS-13-008/009/017/018).
