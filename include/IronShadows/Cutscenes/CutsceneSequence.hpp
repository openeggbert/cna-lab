...
{
    // Gate M8 (plan_26-cutscenes-and-cinematic-sequencing.md IS-26-001/002/005): the smallest
    ...
    // track types (animation/dialogue/audio/event, IS-26-002) are real, separate future work;
    ...
    // back to a hardcoded default (see IronShadowsGame's own fallback) rather than run with a
