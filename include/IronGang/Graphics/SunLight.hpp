...
namespace IronGang
{
    ...
    // Gate M10 (plan_39 IG-39-011's own locked research note): Iron Gang's single shared
    ...
    // no-op on the SOFTWARE backend Iron Gang targets (confirmed by reading its own source),
