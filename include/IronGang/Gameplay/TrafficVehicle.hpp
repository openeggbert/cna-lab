...
namespace IronGang
{
    // Gate M9 (plan_21-traffic-simulation.md IG-21-001/002/004): a single traffic vehicle
    ...
    // externally, see IronGangGame's traffic tick, and pass in just the resulting distance).
    ...
    // plan_21-traffic-simulation.md IG-21-003.
