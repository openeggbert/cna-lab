...
| 081 | `mine_pump_station` — Mine Pump Station | West 80, vent shortcut 79 after fan start, east flooded drift 82 after drainage. | Restart local drainage after restoring ventilation, reducing the current in 82. | Reciprocating pump, pipe shudder. |
| 082 | `flooded_drift` — Flooded Drift | West 81, east 83 after safe retrieval. | Use the magnet-on-cord recovered at 71 to retrieve the lift fuse from the submerged grate. Insulated boots protect Iris from the remaining shallow current. | Magnet swing, water wake, fuse emergence. |
...
| 084 | `freight_lift_bottom` — Freight Lift Bottom | West 83, maintenance crawl to 86, cage to 85 after fuse and power. | Install lift fuse. The visible maintenance crawl reaches the underground substation before the dead cage can move. | Relay click, cage lamp, later lift travel. |
| 085 | `freight_lift_top` — Freight Lift Top | Cage to 84, substation door to 86. | Intermediate landing shows Nightjar cable entering the older mine system. Kade's dropped radio carries Voss's order to flood the shaft and reveals the sealed research route. | Cage doors, radio lamp, cable pulse. |
| 086 | `underground_substation` — Underground Substation | Crawl to 84, powered upper-lift door to 85, aisles 87/88. Travel anchor. | Main routing board. Isolate the switchgear at 87, cut the Quiet Field feed and install the copper bus in 88. | Large knife switches, transformer hum, labelled lamp states. |
...
| 089 | `sealed_research_door` — Sealed Research Door | Between 88 and 90. | Present Kline's research badge, then turn the punched card as June's midnight clue indicates to expose the emergency code. | Card reader text, lock bolts retract. |
